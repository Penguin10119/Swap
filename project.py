...
#music
mixer.init()
mixer.music.load('Guns and roses.mp3')
mixer.music.load('Lose yourself.mp3')
M1 = 'Guns and roses.mp3'
M2 = 'Lose yourself.mp3'
M3 = input("Enter Music choice: Sweet Child O Mine(M1), Lose yourself(M2): ")
if M3 == 'M1':
    mixer.music.play()
elif M3 == 'M2':
    mixer.music.play()
